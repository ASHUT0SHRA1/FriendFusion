...
import notificationIconOutline from '../Assets/notificationoutline.png';
...
const Footer = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <BottomCompo name='About' img={getIcon('About', notificationIcon, notificationIconOutline)} handlef={() => handleNavigation('About')} />
